                ...
                <div class="modal-content">
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="formGroupExampleInput" class="form-label">Judul (Optional)</label>
                                <input type="text" class="form-control" name="judul"
                                    placeholder="Tuliskan Judul/Caption">
                            </div>
                            <div class="mb-3">
...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_POST['id'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO gallery (judul,gambar,tanggal)
                                VALUES (?,?,?)");
